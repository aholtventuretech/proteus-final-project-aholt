...
package com.final_project.app.config;
...
@ComponentScan({"com.final_project.app"})
...
@PropertySource(
    name = "your-app-props",
    value = {
        "classpath:/com/final_project/app/config/default.properties",
...
public class MyAppConfig implements ApplicationListener
{
    ...
    public StaticKeyDataConfig staticKeyDataConfig()
    {
        ...
        config.addScanPackage("com.final_project.app");
        return config;
    }

    /**
     * Scan com.final_project for HBM XML files.
     * @return bean.
     */
    @Bean()
    @LocationQualifier(orm_location)
    public String ormLocationComFinalProject()
    {
        return "classpath*:com/final_project/app/**/*.hbm.xml";
    }
